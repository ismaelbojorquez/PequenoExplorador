...
{
    [Serializable]
    internal sealed class PlayerProgressV9Dto
    {
        ...
        public LearningSessionV9Dto[] LearningSessions => learningSessions; public LearningConceptDailyV9Dto[] LearningConcepts => learningConcepts; public SaveMetadataV1Dto Metadata => metadata;
        public static PlayerProgressV9Dto Create(string version, int starCount, string[] worlds, DiscoveryProgressV4Dto[] discoveryProgress,
            ...
            SaveMetadataV1Dto technicalMetadata) => new PlayerProgressV9Dto
            { appVersion = version, stars = starCount, worldIds = worlds, discoveries = discoveryProgress, processedDiscoveryGrantIds = discoveryGrants,
              ...
              learningSessions = sessions, learningConcepts = concepts, metadata = technicalMetadata };
    }
}
