...
{
    public sealed class PlayerProgressDiscoveryRepository : IDiscoveryProgressRepository
    {
        private readonly ISaveService _save;
        private readonly AutosaveCoordinator _autosave;

        public PlayerProgressDiscoveryRepository(ISaveService save, AutosaveCoordinator autosave)
        {
