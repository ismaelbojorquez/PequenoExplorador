namespace PequenoExplorador.Application.Localization
{
    public static class LocalizationKeys
    {
        ...
        public static readonly LocalizedKey CampHubTitle = new LocalizedKey(UiTable, "ui.camp.hub.title");
        public static readonly LocalizedKey CampStationExpeditionName = new LocalizedKey(UiTable, "ui.camp.station.expedition.name");
        public static readonly LocalizedKey CampStationExpeditionDescription = new LocalizedKey(UiTable, "ui.camp.station.expedition.description");
        public static readonly LocalizedKey CampStationAlbumName = new LocalizedKey(UiTable, "ui.camp.station.album.name");
        public static readonly LocalizedKey CampStationAlbumDescription = new LocalizedKey(UiTable, "ui.camp.station.album.description");
        public static readonly LocalizedKey CampStationCustomizationName = new LocalizedKey(UiTable, "ui.camp.station.customization.name");
        public static readonly LocalizedKey CampStationCustomizationDescription = new LocalizedKey(UiTable, "ui.camp.station.customization.description");
        public static readonly LocalizedKey CampStationParentsName = new LocalizedKey(UiTable, "ui.camp.station.parents.name");
        public static readonly LocalizedKey CampStationParentsDescription = new LocalizedKey(UiTable, "ui.camp.station.parents.description");
        public static readonly LocalizedKey CampUpgradeObservationName = new LocalizedKey(UiTable, "ui.camp.upgrade.observation.name");
        public static readonly LocalizedKey CampUpgradeObservationDescription = new LocalizedKey(UiTable, "ui.camp.upgrade.observation.description");
        public static readonly LocalizedKey CampUpgradeObservationPreview = new LocalizedKey(UiTable, "ui.camp.upgrade.observation.preview");
        public static readonly LocalizedKey CampUpgradeCost = new LocalizedKey(UiTable, "ui.camp.upgrade.cost");
        public static readonly LocalizedKey CampUpgradeConfirm = new LocalizedKey(UiTable, "ui.camp.upgrade.confirm");
        public static readonly LocalizedKey CampUpgradeCancel = new LocalizedKey(UiTable, "ui.camp.upgrade.cancel");
        public static readonly LocalizedKey CampUpgradePurchased = new LocalizedKey(UiTable, "ui.camp.upgrade.purchased");
        public static readonly LocalizedKey CampUpgradeCompleted = new LocalizedKey(UiTable, "ui.camp.upgrade.completed");
        public static readonly LocalizedKey CampUpgradeUnavailable = new LocalizedKey(UiTable, "ui.camp.upgrade.unavailable");
        public static readonly LocalizedKey CustomizationTitle = new LocalizedKey(UiTable, "ui.customization.title");
        public static readonly LocalizedKey CustomizationBalance = new LocalizedKey(UiTable, "ui.customization.balance");
        public static readonly LocalizedKey CustomizationAvailable = new LocalizedKey(UiTable, "ui.customization.available");
        public static readonly LocalizedKey CustomizationCost = new LocalizedKey(UiTable, "ui.customization.cost");
        public static readonly LocalizedKey CustomizationProgressLocked = new LocalizedKey(UiTable, "ui.customization.progress_locked");
        public static readonly LocalizedKey CustomizationUnlockStars = new LocalizedKey(UiTable, "ui.customization.unlock_stars");
        public static readonly LocalizedKey CustomizationUnlockProgress = new LocalizedKey(UiTable, "ui.customization.unlock_progress");
        public static readonly LocalizedKey CustomizationEquip = new LocalizedKey(UiTable, "ui.customization.equip");
        public static readonly LocalizedKey CustomizationClose = new LocalizedKey(UiTable, "ui.customization.close");
        public static readonly LocalizedKey CustomizationUnlocked = new LocalizedKey(UiTable, "ui.customization.unlocked");
        public static readonly LocalizedKey CustomizationEquipped = new LocalizedKey(UiTable, "ui.customization.equipped");
        public static readonly LocalizedKey CustomizationIncompatible = new LocalizedKey(UiTable, "ui.customization.incompatible");
        public static readonly LocalizedKey CustomizationUnavailable = new LocalizedKey(UiTable, "ui.customization.unavailable");
