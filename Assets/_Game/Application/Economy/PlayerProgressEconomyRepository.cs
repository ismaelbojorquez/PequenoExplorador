...
{
    public sealed class PlayerProgressEconomyRepository : IEconomyRepository
    {
        private readonly ISaveService _save;
        private readonly AutosaveCoordinator _autosave;
        public PlayerProgressEconomyRepository(ISaveService save, AutosaveCoordinator autosave)
