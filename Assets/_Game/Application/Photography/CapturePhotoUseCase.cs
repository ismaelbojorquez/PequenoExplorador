        ...
        public async Task<PhotoCaptureResult> ExecuteAsync(IPhotographable photographable, string captureId, CancellationToken cancellationToken)
        {
            ...
            try
            {
                ...
                if (existing != null && existing.ScorePermille >= evaluation.ScorePermille)
                    return new PhotoCaptureResult(PhotoCaptureOutcome.ExistingPhotoKept, evaluation, discovery, existing);
                ...
                try
                {
                    ...
                    return new PhotoCaptureResult(
                        ...
                        evaluation, discovery, photo);
                }
                catch (OperationCanceledException) { throw; }
                catch (Exception)
                {
                    return new PhotoCaptureResult(PhotoCaptureOutcome.CapturedWithoutThumbnail, evaluation, discovery, existing);
                }
            }
