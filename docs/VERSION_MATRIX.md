...
| Localization | `1.5.12` + Android JNI builtin `1.0.0` | Verificado oficial/local | Registry/manual/licencia, import, ES/EN/pseudo y APK, 2026-08-16 | Pin estable; Unity Companion License, tablas locales, sin SDK/endpoint/binario nativo del paquete. |
| Unity Audio module | `com.unity.modules.audio@1.0.0` | Verificado builtin/local | Manifest/lock, Editor `6000.3.22f1`, compile/tests, 2026-08-16 | AudioSource/Clip/Mixer engine-only; sin red, datos o SDK externo. |
