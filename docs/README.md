...
Estado: foundation, scene flow local, persistencia schema v10, localización/audio/input, `VS-D-A01` runtime Approved, locomoción, interacción, discovery, fotografía, álbum, economía, misión, learning, actividad integrada y Camp progresivo disponibles; todavía no existe contenido masivo ni arte final. Empezar siempre por [`../AGENTS.md`](../AGENTS.md) y [`STATUS.md`](STATUS.md).
...
- [`10_SAVE_SYSTEM.md`](10_SAVE_SYSTEM.md): schema v10, DTOs, checksum, backup, migraciones, autosave y recuperación.
