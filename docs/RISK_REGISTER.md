...
| R-002 | AAB o librería nativa no soporta páginas de 16 KB. | 2 | 5 | 10 | APK F03 pasó zipalign/ELF y emulador 16 KB; repetir AAB/bundletool y todo SDK futuro. | Release Eng | F11, F47 |
| R-003 | Deadline API 36 del 2026-08-31 bloquea publicación. | 2 | 5 | 10 | ProjectSettings y APK reportan target/compile 36; falta AAB/Play pre-launch y revalidación. | Release Eng | F11, F47 |
...
| R-025 | Manifest Release conserva red/permisos no justificados por un build Development. | 3 | 5 | 15 | El smoke solo mostró `INTERNET` y permiso interno; generar AAB Release, comparar merged manifest y bloquear permisos no aprobados. | Privacy + Release | F11, F49 |

## Riesgo residual tras Fase 03

Import, tests, APK y emulador reducen R-001/R-002/R-003/R-009, pero no prueban AAB Release, firma, dispositivo físico, performance, safe area, iOS ni aceptación de tienda. R-006, R-024 y R-025 continúan explícitos. No hubo gameplay, playtest infantil ni validación legal/store.
