...
| R-029 | Perfil Release activa por error mocks/diagnóstico o lifecycle deja servicios/listeners vivos. | 2 | 5 | 10 | Mocks bajo define exclusivo de Development, registry Release fail-closed, orden/shutdown/cancelación y bus sin listeners cubiertos por tests. | Principal Eng | Cada cambio de servicios/build |

## Riesgo residual tras Fase 06

Import, tests de frontera/lifecycle/perfiles, APK y evidencia histórica de emulador reducen R-001/R-002/R-003/R-009/R-026/R-029, pero no prueban un binario Release sin mocks, AAB, firma, dispositivo físico, performance, safe area, iOS ni aceptación de tienda. R-006, R-024, R-025 y la porción binaria de R-029 continúan explícitos. No hubo gameplay, playtest infantil ni validación legal/store.
