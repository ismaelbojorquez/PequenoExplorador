...
| R-012 | Estado local se pierde/corrompe o expone información infantil. | 2 | 4 | 8 | Schema v2 sin PII, checksum, temp/flush/replace, backup preservado, future read-only y migraciones v0→v1→v2 testeadas. Resta dispositivo físico, falta de espacio y matriz destructiva F34. | Principal Eng | F09, F34 |
...
| R-032 | Copy ausente, truncado o no revisado rompe comprensión infantil o muestra IDs técnicos. | 3 | 4 | 12 | 25 keys ES/EN no vacías, fallback Release seguro, pseudo 1280×720/1920×1080, validator bloqueante y revisión lingüística/Child UX antes de contenido final. | Localization + UX | Cada lote/F37 |
