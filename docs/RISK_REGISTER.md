...
|---|---|---:|---:|---:|---|---|---|
| R-001 | Unity latest-patch cambia o `6000.3.22f1` presenta regresión crítica. | 3 | 4 | 12 | Pin provisional, smoke build y ADR antes de contenido; no migración silenciosa. | Tech Director | F02, mensual |
...
| R-003 | Deadline API 36 del 2026-08-31 bloquea publicación. | 4 | 5 | 20 | Target/compile 36 desde F02; Play pre-launch y revalidación. | Release Eng | F02, F47 |
...
| R-009 | Activación/licencia Unity no permite batch build. | 2 | 4 | 8 | Verificar activación en F02 sin guardar credenciales. | Owner + Release | F02 |
...
## Riesgo residual tras Fase 01

No se ejecutó build, playtest real ni validación de tienda porque no existe proyecto. R-001/R-002/R-003/R-006/R-009/R-017–R-020 siguen abiertos: la documentación reduce incertidumbre, pero no los convierte en PASS.
