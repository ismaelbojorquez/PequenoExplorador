...
| H-007 | Aprobación factual y responsables de contenido. Ismael Bojórquez (Creador) aprobó Product/Education/Localization y declaró Art/Audio/Rights/QA el 2026-08-16; eligió `Tucán pico canoa`. Especialista factual y evidencia por asset siguen pendientes en el [dossier VS-D-A01](VS_D_A01_TOUCAN_FACTUAL_DOSSIER.md). | Producto + educación + especialista factual | Antes de producir contenido del slice o iniciar Prompt 19. |
