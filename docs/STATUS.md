...
- Prompt 19 exige un animal fixture Approved, pero el único discovery/animal actual es neutral Draft. H-007 (especialista factual, fuentes/revisión/aprobación y assets con derechos) bloquea iniciar fotografía sin falsear el gate editorial.
...
Resolver con aprobación humana el fixture animal exigido por Prompt 19 y luego ejecutar su preflight. No marcar Draft como Approved, introducir contenido masivo, cámara física/permisos, segundo mundo, remote, signing, push o publicación.
