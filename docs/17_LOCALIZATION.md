...
El validador recorre 122 entradas runtime tras Prompt 24: la baseline previa más keys de actividad ES/EN para definición, opciones, pistas, controles, instrucción y fact de audio. Todas son namespaced; `LocalizationKeys.cs` conserva las keys de uso común y las definitions data-driven aportan su copy. Voz y subtítulo comparten concepto. Las tablas permanecen locales, sin `Remote*`, URL ni update-on-start.
