...
|---|---|---|---|
| Save v10 | progreso técnico, preferencias ES/EN/audio/guía, discovery, grants, foto, economía/misiones, agregados learning concepto+día y IDs de mejoras Camp | Sin red/permiso | Sin nombre, edad, fecha de nacimiento, cuenta, device/advertising ID, respuestas/taps ni raw event log. |
